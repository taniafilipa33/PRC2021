...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs" version="2.0">    
    ...
    ### http://www.semanticweb.org/comta/ontologies/arquivoMusica#<xsl:value-of select="@id"/>
    :<xsl:value-of select="@id"/> rdf:type owl:NamedIndividual ,
    :Obra ;
    <xsl:if test="inf-relacionada">
        <xsl:if test="inf-relacionada/video">
    :contém :video<xsl:value-of select="@id"/>;
        </xsl:if>
    </xsl:if>
    ...
    <xsl:if test="inf-relacionada">
        <xsl:if test="inf-relacionada/video">
    ### http://www.semanticweb.org/comta/ontologies/arquivoMusica#video<xsl:value-of select="@id"/>
    ...
    ###  http://www.semanticweb.org/comta/ontologies/arquivoMusica#<xsl:value-of select="replace(replace(compositor,' ','_'),',','')"/>
    ...
    ###  http://www.semanticweb.org/comta/ontologies/arquivoMusica#<xsl:value-of select="replace(designacao,' ','_')"/>/>
    ...
    ### http://www.semanticweb.org/comta/ontologies/arquivoMusica#<xsl:value-of select="@path"/>
    :<xsl:value-of select="@path"/> rdf:type owl:NamedIndividual ,
    :Partitura ;
    :nomePartitura :<xsl:value-of select="replace(../designacao,' ','_')"/> ;
